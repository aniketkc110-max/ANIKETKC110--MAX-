...
<head>
    ...
    <meta name="description" content="Z2M Developer Portfolio - Showcasing projects, slides, and skills.">
    ...
    <style>
        ...
        * {
        ...
        #hero {
            ...
            padding-bottom: 80px;
            min-height: 80vh; /* Adjusted slightly to fit content better */
            display: flex;
            align-items: center;
        }
...
<body>
        ...
        <div class="container">
            <nav>
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="#presentation">Slides</a></li> <!-- New Nav Link -->
    ...
    <main>
            ...
            <div class="container">
                <div class="hero-content">
                    <div class="hero-text">
                        ...
                        <p>I build accessible, pixel-perfect, and performant web experiences. Check out my latest projects and presentation slides below.</p>
                        <div class="cta-buttons">
                            <a href="#projects" class="btn btn-primary">View Work</a>
                            <a href="#presentation" class="btn btn-outline">Watch Slides</a>
                        </div>
                    </div>
        ...
        <section id="presentation">
            <div class="container">
                <h2 class="section-title">My Presentation</h2>
                <p class="section-subtitle">A deep dive into my recent project or talk.</p>
                
                <div class="presentation-wrapper">
                    <div class="iframe-container">
                        <!-- 
                           I converted your link to an embed link.
                           Original: /pub?...
                           Embed: /embed?...
                        -->
                        <iframe 
                            src="https://docs.google.com/presentation/d/e/2PACX-1vSnNRTMv9bH7IoT2zEK3HxX5kWM7I3STaNbJS3FM4Uuqe44uN-3UnB_XRnNyAK4iSrMElck9fMMY99K/embed?start=false&loop=false&delayms=3000" 
                            frameborder="0" 
                    ...
                    <div class="presentation-desc">
                        <p>Use the arrows to navigate the slides.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="projects">
            <div class="container">
                ...
                <p class="section-subtitle">A selection of code projects I've built.</p>
                ...
                <div class="projects-grid">
                    ...
                    <article class="project-card">
                        ...
                        <div class="card-content">
                            <h3>Task Master</h3>
                            <p>A productivity app to manage daily tasks. Includes drag-and-drop functionality and local storage persistence.</p>
                            <div class="card-tags">
                                <span class="card-tag">Vanilla JS</span>
                                <span class="card-tag">DOM</span>
                            </div>
                            <div class="card-links">
                                <a href="#" class="link-icon">Live Demo &nearr;</a>
                                <a href="#" class="link-icon">GitHub &lt;/&gt;</a>
